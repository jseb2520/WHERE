  ...
  return (
    <>
      <Block factor={1} offset={0}>
        <Block factor={1.2}>
          <Text left size={w * 0.08} position={[-w / 3.2, 0.5, -1]} color="#E9B418">
            WHERE
          </Text>
        </Block>
        <Block factor={1.2}>
          <HTML position={[-w / 3.2, -w * 0.08 + 0.25, -1]}>Turning your requests{mobile ? <br /> : " "} into optimal solutions.</HTML>
          {/* <Text left size={w * 0.02} position={[-w * 0.8, -1, -1]} color="#ffff">
            Turning your requests into optimal solutions.
          </Text> */}
        </Block>
      </Block>
